...
class _ChatRoomState extends State<ChatRoom> {
  ...
  getUserInfogetChats() async {
    Constants.nameUser = await HelperFunctions.getUserName();
    DatabaseMethods().getUserChats(Constants.nameUser).then((snapshots) {
      setState(() {
        chatRooms = snapshots;
        print(
            "we got the data + ${chatRooms.toString()} this is name  ${Constants.nameUser}");
      });
    });
  }
